...
Use this page when you are contributing to `coding-mcp` itself. For normal usage, agents can work remotely through MCP without cloning target repositories to the agent machine.
